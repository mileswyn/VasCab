...
class ExperimentPlanner3D_v21_all_vessel(ExperimentPlanner):
    """
    ...
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        super(ExperimentPlanner3D_v21_all_vessel, self).__init__(folder_with_cropped_data, preprocessed_output_folder)
        self.data_identifier = "nnUNetData_plans_v2.1"
        self.plans_fname = join(self.preprocessed_output_folder,
                                "nnUNetPlansv2.1_plans_3D.pkl")
        self.unet_base_num_features = 32
        self.list_of_cropped_npz_files = [subfiles(self.folder_with_cropped_data[i], True, None, ".npz", True) for i in range(len(self.folder_with_cropped_data))]
        self.dataset_properties = load_pickle(join(self.folder_with_cropped_data[0], "dataset_properties_all_vessel.pkl"))

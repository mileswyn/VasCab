...
def main():
    ...
    parser.add_argument("-i", '--input_folder', help="Must contain all modalities for each patient in the correct"
                                                     ...
                                                     default='/data2/wyn/nnUNetFrame/nnUNet_raw_data_base/nnUNet_raw_data/Task303_CTA_KiPA/imagesTs/')
    parser.add_argument('-o', "--output_folder", required=False, help="folder for saving predictions",
                        default='/data2/wyn/nnUNetFrame/nnUNet_trained_models/nnUNet/3d_fullres/Task303_CTA_KiPA/nnUNetTrainerV2__nnUNetPlansv2.1/all/all/')
    parser.add_argument('-t', '--task_name', help='task name or task                                                                                                                                 ID, required.',
                        default='Task303_CTA_KiPA', required=False)

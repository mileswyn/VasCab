...
# from nnunet.inference.predict_singlethread import predict_from_folder
...
def main():
    ...
    parser.add_argument("-i", '--input_folder', help="Must contain all modalities for each patient in the correct"
                                                    ...
                                                    #  default='/path/to/nnUNetFrame/nnUNet_raw_data_base/nnUNet_raw_data/Task301_CTA_Meng/imagesTs/')
                                                    default='/path/to/nnUNetFrame/nnUNet_raw_data_base/nnUNet_raw_data/Task411_Crown_MRA/imagesTs/')
    parser.add_argument('-o', "--output_folder", required=False, help="folder for saving predictions",
                        default='/path/to/nnUNetFrame/nnUNet_trained_models/nnUNet/3d_fullres/Task305_7Vesseltask/nnUNetTrainerV3__UniVessel_bs4/all/411_tsne_better/')
    parser.add_argument('-t', '--task_name', help='task name or task ID, required.',
                        default='Task305_7Vesseltask', required=False)
    parser.add_argument('-g', '--give_prior', help='If domain prior shall be given as network input.',
    ...
    if model == "3d_cascade_fullres" and lowres_segmentations is None:
        ...
        #                           args.plans_identifier + '__hermes_before')
        model_folder_name = join(network_training_output_dir, "3d_lowres", task_name, trainer_class_name + "__" +
    ...
    predict_from_folder(model_folder_name, input_folder, output_folder, folds, save_npz, num_threads_preprocessing,
                        ...
                        overwrite_existing=overwrite_existing, mode=mode, overwrite_all_in_gpu=all_in_gpu,
                        mixed_precision=not args.disable_mixed_precision,
                        step_size=step_size, checkpoint_name=args.chk, give_prior=args.give_prior)

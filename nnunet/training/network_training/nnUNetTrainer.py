...
class nnUNetTrainer(NetworkTrainer):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        self.online_eval_fp = []
        self.online_eval_fn = []
        self.online_classification_mod = []
    ...
    def get_basic_generators(self, give_prior=False):
        ...
        if self.threeD:
            dl_tr = DataLoader3D(self.dataset_tr, self.basic_generator_patch_size, self.patch_size, self.batch_size,
                                 ...
                                 pad_mode="constant", pad_sides=self.pad_all_sides, memmap_mode='r', give_prior=False)
    ...
    def finish_online_evaluation(self):
        ...
        # modality loss新增
        # if self.online_classification_mod:
        #     self.online_classification_mod = np.sum(self.online_classification_mod, 0)
        #     self.print_to_log_file("Average classification loss:", np.mean(self.online_classification_mod))
        ...
        # self.print_to_log_file("Average global foreground Dice:", [np.round(i, 4)[0] for i in global_dc_per_class])

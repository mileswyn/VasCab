...
from nnunet.dataset_conversion.Task103_MTvessels_mod_spacing import MultiTalent_regions, MultiTalent_region_output_idx_mapping, \
...
# class MultiTalent_trainer_ddp(nnUNetTrainerV2):
    def __init__(self, plans_file, fold, local_rank, output_folder=None, dataset_directory=None, batch_dice=True,
        ...
        batch_dice = True
        # super().__init__(plans_file=plans_file, fold=fold, output_folder=output_folder,
    ...
    def process_plans(self, plans):
        ...
        # self.patch_size = np.array((80,192,160)).astype(int)

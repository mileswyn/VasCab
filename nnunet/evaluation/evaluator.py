        ...
        if isinstance(self.labels, dict):
            ...
            for i, l in enumerate(self.labels):
                ...
                for metric in eval_metrics:
                    ...
                    #                                         nan_for_nonexisting=self.nan_for_nonexisting,
                    #                                         **metric_kwargs)
                    # 2024.10.30: betti number需要test和inference输入
                    if "betti_err" in metric:
                        self.result[k][metric] = _funcs[metric](self.test, self.reference, confusion_matrix=self.confusion_matrix,
                                                                nan_for_nonexisting=self.nan_for_nonexisting,
                                                                **metric_kwargs)
                    else:
                        self.result[k][metric] = _funcs[metric](confusion_matrix=self.confusion_matrix,
...
def aggregate_scores(test_ref_pairs,
    ...
    # for t,r,e,m in zip(test, ref, [evaluator]*len(ref), [metric_kwargs]*len(ref)):
    #     ars = (t,r,e,m)
    #     res = run_evaluation(ars)
    p = Pool(num_threads)
...
def evaluate_folder(folder_with_gts: str, folder_with_predictions: str, ori_folder: str, labels: tuple, **metric_kwargs):
    """
    ...
    res = aggregate_scores(test_ref_pairs, output_dir=ori_folder, json_output_file=join(folder_with_predictions, "summary_cldice_betti.json"),
...
if __name__ == '__main__':
    # out_dir = '/data2/wyn/nnUNetFrame/nnUNet_trained_models/nnUNet/3d_fullres/Task103_MTvessels_mod_spacing/MultiTalent_trainer_ddp__MultiTalent_bs4/all/all/corres/'
    # evaluate_folder(
    #     '/data2/wyn/nnUNetFrame/nnUNet_raw_data_base/nnUNet_raw_data/Task101_MTvessel/labelsTs_single_label/',
    #     '/data2/wyn/nnUNetFrame/nnUNet_trained_models/nnUNet/3d_fullres/Task103_MTvessels_mod_spacing/MultiTalent_trainer_ddp__MultiTalent_bs4/all/all/corres/',
    #     out_dir,
    #     (0, 1))

    # 301 task-specific nnunet的结果
    # out_dir = '/data2/wyn/nnUNetFrame/nnUNet_trained_models/nnUNet/3d_fullres/Task405_CTA_AIIB23trachea/nnUNetTrainerV2__nnUNetPlansv2.1/all/all/'
    # evaluate_folder(
    #     '/data2/wyn/nnUNetFrame/nnUNet_raw_data_base/nnUNet_raw_data/Task405_CTA_AIIB23trachea/labelsTs/',
    #     '/data2/wyn/nnUNetFrame/nnUNet_trained_models/nnUNet/3d_fullres/Task405_CTA_AIIB23trachea/nnUNetTrainerV2__nnUNetPlansv2.1/all/all/',
    #     out_dir,
    #     (0, 1))
    
    # 304 general nnunet的结果
    # out_dir = '/data2/wyn/nnUNetFrame/nnUNet_trained_models/nnUNet/3d_fullres/Task304_MixVessel/nnUNetTrainerV3__nnUNetPlansv2.1/all_not_init_nnlinear/'
    # evaluate_folder(
    #     '/data2/wyn/nnUNetFrame/nnUNet_raw_data_base/nnUNet_raw_data/Task304_MixVessel/labelsTs/',
    #     '/data2/wyn/nnUNetFrame/nnUNet_trained_models/nnUNet/3d_fullres/Task304_MixVessel/nnUNetTrainerV3__nnUNetPlansv2.1/all_not_init_nnlinear/',
    #     out_dir,
    #     (0, 1))
    
    # 302 task-specific nnunet的结果
    out_dir = '/data2/wyn/nnUNetFrame/nnUNet_trained_models/nnUNet/3d_fullres/Task411_Crown_MRA/nnUNetTrainerV2__nnUNetPlansv2.1/all/all/'
    evaluate_folder(
        '/data2/wyn/nnUNetFrame/nnUNet_raw_data_base/nnUNet_raw_data/Task411_Crown_MRA/labelsTs/',
        '/data2/wyn/nnUNetFrame/nnUNet_trained_models/nnUNet/3d_fullres/Task411_Crown_MRA/nnUNetTrainerV2__nnUNetPlansv2.1/all/all/',
        out_dir,
        (0, 1))
    
    # SAM-Med3D 比较
    # tdir = '/data2/wyn/sammed3d_result_asset/fine_tune_vessels/'
    # for task in os.listdir(tdir):
    #     print('fine_tune_vessels: ', task)
    #     out_dir = os.path.join(tdir, task)
    #     evaluate_folder(
    #     os.path.join('/data2/wyn/nnUNetFrame/nnUNet_raw_data_base/nnUNet_raw_data', task, 'labelsTs'),
    #     out_dir,
    #     out_dir,
    #     (0, 1))

    # tdir = '/data2/wyn/sammed3d_result_asset/zero_shot_vessels/'
    # for task in os.listdir(tdir):
    #     print('zero_shot_vessels: ', task)
    #     out_dir = os.path.join(tdir, task)
    #     evaluate_folder(
    #     os.path.join('/data2/wyn/nnUNetFrame/nnUNet_raw_data_base/nnUNet_raw_data', task, 'labelsTs'),
    #     out_dir,
    ...
    # task305_7vessels
    # tlist = ['Task405_CTA_AIIB23trachea', 'Task411_Crown_MRA', 'Task409_topCowCTA', 
    #          'Task303_CTA_KiPA', 'Task407_Parse22_pulmonary_artery', 'Task410_topCowMRA', 'Task412_Coron']
    # # tlist = ['Task405_CTA_AIIB23trachea', 'Task411_Crown_MRA', 'Task409_topCowCTA', 
    # #          'Task303_CTA_KiPA', 'Task407_Parse22_pulmonary_artery', 'Task410_topCowMRA']
    # # tlist = ['Task412_Coron', 'Task405_CTA_AIIB23trachea']
    # # tlist = ['Task411_Crown_MRA', 'Task409_topCowCTA', 
    # #          'Task303_CTA_KiPA',  'Task410_topCowMRA', 'Task412_Coron']
    # # tdir = '/data2/wyn/nnUNetFrame/nnUNet_trained_models/nnUNet/3d_fullres/Task305_7Vesseltask/nnUNetTrainerV3__UniVessel_bs4/before_a_ll/'
    # tdir = '/data2/wyn/nnUNetFrame/nnUNet_trained_models/nnUNet/3d_fullres/Task305_7Vesseltask/nnUNetTrainerV3__UniVessel_bs4/before_a_ll/'
    # for task in tlist:
    #     task_id = task.split('Task')[-1].split('_')[0] + '_v1_test'
    #     # task_id = task
    #     print('task: ', task_id)
    #     out_dir = os.path.join(tdir, task_id)
    #     evaluate_folder(
    #     os.path.join('/data2/wyn/nnUNetFrame/nnUNet_raw_data_base/nnUNet_raw_data', task, 'labelsTs'),
    #     out_dir,
    #     out_dir,
    ...
    # tlist = ['Task405_CTA_AIIB23trachea', 'Task406_AortaSeg24',]
    #         #  'Task411_Crown_MRA', 'Task409_topCowCTA', #'Task406_AortaSeg24', 'Task407_Parse22_pulmonary_artery',
    #          #'Task303_CTA_KiPA', 'Task410_topCowMRA']
    # tdir = '/data2/wyn/nnUNetFrame/nnUNet_trained_models/nnUNet/3d_fullres/Task103_MTvessels_mod_spacing/MultiTalent_trainer_ddp__MultiTalent_bs4/all/all/'
    # for task in tlist:
    #     task_id = 'softmax'+'_'+task.split('Task')[-1].split('_')[0]
    #     print('task: ', task_id)
    #     out_dir = os.path.join(tdir, task_id)
    #     evaluate_folder(
    #     os.path.join('/data2/wyn/nnUNetFrame/nnUNet_raw_data_base/nnUNet_raw_data', task, 'labelsTs'),
    ...
    # tlist = [ 'Task303_CTA_KiPA', 'Task302_MRA_Bai', 'Task301_CTA_Meng']
    #         #  'Task411_Crown_MRA', 'Task409_topCowCTA', #'Task406_AortaSeg24', 'Task407_Parse22_pulmonary_artery',
    #          # 'Task410_topCowMRA'] 'Task405_CTA_AIIB23trachea', 'Task406_AortaSeg24','Task303_CTA_KiPA','Task302_MRA_Bai', 
    # tdir = '/data2/wyn/universal-medical-image-segmentation/prediction/'
    # for task in tlist:
    #     task_id = task.split('Task')[-1].split('_')[0] + '_clear'
    #     print('task: ', task_id)
    #     out_dir = os.path.join(tdir, task_id)
    #     evaluate_folder(
    #     os.path.join('/data2/wyn/nnUNetFrame/nnUNet_raw_data_base/nnUNet_raw_data', task, 'labelsTs'),

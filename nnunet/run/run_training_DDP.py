...
def main():
    ...
    parser.add_argument("--network_trainer", required=False, default='MultiTalent_trainer_ddp')
    parser.add_argument("--task", required=False, help="can be task name or task id", default='103')
    ...
    parser.add_argument("-p", help="plans identifier. Only change this if you created a custom experiment planner",
                        default='MultiTalent_bs4', required=False)
...
if __name__ == "__main__":
    ...
    # # TODO
    # os.environ['MASTER_PORT'] = '15363'
    os.environ['CUDA_VISIBLE_DEVICES'] = '1'
    main()
    # mp.spawn(main, args=(1, ), nprocs=1, join=True)

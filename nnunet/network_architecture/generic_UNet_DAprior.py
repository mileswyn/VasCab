...
class Generic_UNet_DAprior(SegmentationNetwork):
    ...
    def __init__(self, input_channels, base_num_features, num_classes, num_pool, num_conv_per_stage=2,
        ...
        """
        super(Generic_UNet_DAprior, self).__init__()
        ...
        self.w = 160
        self.h = 160
        feature_size = [self.d, self.w, self.h]
        ...
        # self.domain_prior_init_fuse_1 = DomainPriorInitFusionLayer(output_features, output_features, feature_size, block_num=2, task_prior_num=self.tn, modality_prior_num=self.mn)
        input_features = output_features
        output_features = int(np.round(output_features * feat_map_mul_on_downscale))
        output_features = min(output_features, self.max_num_features)
        ...
        self.domain_prior_init_fuse_2 = DomainPriorInitFusionLayer(output_features, output_features, [i // 4 for i in feature_size], task_prior_num=self.tn, modality_prior_num=self.mn)
        input_features = output_features
        output_features = int(np.round(output_features * feat_map_mul_on_downscale))
        output_features = min(output_features, self.max_num_features)
        ...
        self.domain_prior_init_fuse_3 = DomainPriorInitFusionLayer(output_features, output_features, [i // 8 for i in feature_size], task_prior_num=self.tn, modality_prior_num=self.mn)
        input_features = output_features
        output_features = int(np.round(output_features * feat_map_mul_on_downscale))
        output_features = min(output_features, self.max_num_features)
        ...
        self.domain_prior_init_fuse_4 = DomainPriorInitFusionLayer(output_features, output_features, [i // 16 for i in feature_size], task_prior_num=self.tn, modality_prior_num=self.mn)
        input_features = output_features
        output_features = int(np.round(output_features * feat_map_mul_on_downscale))
        output_features = min(output_features, self.max_num_features)
        ...
        self.domain_prior_fuse_5 = DomainPriorInitFusionLayer(final_num_features, final_num_features, [i // 16 for i in feature_size], task_prior_num=self.tn, modality_prior_num=self.mn)
        ...
        self.domain_prior_fuse_6 = DomainPriorInitFusionLayer(final_num_features, final_num_features, [i // 8 for i in feature_size], task_prior_num=self.tn, modality_prior_num=self.mn)
        ...
        self.domain_prior_fuse_7 = DomainPriorInitFusionLayer(final_num_features, final_num_features, [i // 4 for i in feature_size], task_prior_num=self.tn, modality_prior_num=self.mn)
...
class Generic_UNet_DAprior_featuremaps(Generic_UNet_DAprior):
    def forward(self, x):
        skips = []
        seg_outputs = []
        for d in range(len(self.conv_blocks_context) - 1):
